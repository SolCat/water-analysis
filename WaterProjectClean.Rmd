...
```{r echo=FALSE, out.width='49%', fig.cap="Répartition des eaux par nature"}
acpn = function(data_in, round_precision = 3){  
  result = list()
...
####Analyse croisée des variables et observations
```{r echo=FALSE, out.width='49%', fig.cap="Projection des observations", fig.align="center"}
...
```{r echo=FALSE, out.width='49%', fig.cap="Cercle des corrélations", fig.align="center"}
s.corcircle(auto.acp$co, xax=1, yax=2); mtext("Plan 1-2")
s.corcircle(auto.acp$co, xax=1, yax=3); mtext("Plan 1-3")
s.corcircle(auto.acp$co, xax=2, yax=3); mtext("Plan 2-3")
```

<div style="text-align:center">Figure 12
