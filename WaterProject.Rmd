...
L'eau est un élément central dans notre vie quotidienne. 
...
Les cercles de corrélation obtenues via notre ACP, identiques à ceux présentés plus haut, sont disponibles en annexe de ce rapport.
...
Grace au graphique, on peut remarquer qu'à k=5, la qualité de représentation ne progresse plus beaucoup. 5 semble donc être raisonnable. Une fois exectuté, l'algorithme nous revoie un tableau des individus classés. On peut donc, pour se donner une idée, appliquer ce tableau à une représentation en deux ou trois dimensions issue de l'ACP.
